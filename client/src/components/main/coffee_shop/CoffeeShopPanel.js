        ...
        <div className="panel-detail">
          ...
          <div className="panel-coffee">
            <div className="panel-processing">
              ...
              <g>
                <path d="M207.2,48.8C195.9,37.5,180,32,163,32c0,0,0,0,0,0c-28.5,0-61.9,14.7-89.1,41.9c-43.7,43.7-55,103.4-25.1,133.3
                ...
                <path d="M155,81.8c-4.4,3.1-8.9,6.6-13.5,10.5c-0.6,0.5-1.1,1-1.7,1.5l-0.9,0.8l-0.4,0.4l-0.1,0.1l-0.1,0c-0.1,0.1,0.1-0.1-0.2,0.2
              ...
              <p>{shop.coffees.length >=1 ? shop.coffees[0].processing : "This shop has no coffee!"}</p>
            </div>
            <div className="panel-origin">
              ...
              <p>{shop.coffees.length >=1 ? shop.coffees[0].origin : 'No origin listed'}</p>
            </div>
            <div className="panel-flavors">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                <g>
                  ...
                  <path d="M194.7,120H61.3c-2.4,0-4.2,2.1-4,4.4c1.7,15,5.4,37,14,56.5c12.7,29,31.2,43.1,56.6,43.1s43.9-14.1,56.6-43.1
              ...
              <p>{shop.coffees.length >= 1 ? shop.coffees[0].flavor.slice(0, 2).join(", ") : 'No flavors listed'}</p>
            </div>
          </div>
        </div>
      </Link>
